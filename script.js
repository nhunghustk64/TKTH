...
function makeComment(text, id) {
	...
	<div class="comment-container">
		<div class="comment">
		<img src="https://scontent.fhan5-8.fna.fbcdn.net/v/t39.30808-1/s200x200/269143788_10209401597994380_949662896031155775_n.jpg?_nc_cat=110&ccb=1-5&_nc_sid=7206a8&_nc_ohc=QRyH46AXxI0AX94E1Ng&_nc_oc=AQmtFFIj8HZ8GfEmA0wdxX8k4HwIjPJCe3g8GqT7pONJOQPtYb3TdUm0VZUOpnfcmI0&_nc_ht=scontent.fhan5-8.fna&oh=00_AT_9klAbTineXd_oo7I47jeZZ_i0_7bma_D_ZUQqg4Zx1w&oe=61D465E5" alt="" class="comment-img">
		<div class="comment-text">
			<div class="comment-header">
			<p><strong>Đặng Hương</strong></p>
			</div>
			<p>${text}</p>
		</div>
		<div class="three-dot">
